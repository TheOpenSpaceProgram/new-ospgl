...
FN_DECIMAL fn_cellular2(FastNoise* fn, FN_DECIMAL x, FN_DECIMAL y);
FN_DECIMAL fn_cubic2(FastNoise* fn, FN_DECIMAL x, FN_DECIMAL y);
FN_DECIMAL fn_cubic_fractal2(FastNoise* fn, int x, int y);
void fn_gradient_perturb2(FastNoise* fn, FN_DECIMAL* x, FN_DECIMAL* y);
void fn_gradient_perturb_fractal2(FastNoise* fn, FN_DECIMAL* x, FN_DECIMAL* y);
...
FN_DECIMAL fn_cellular3(FastNoise* fn, FN_DECIMAL x, FN_DECIMAL y, FN_DECIMAL z);
FN_DECIMAL fn_cubic3(FastNoise* fn, FN_DECIMAL x, FN_DECIMAL y, FN_DECIMAL z);
FN_DECIMAL fn_cubic_fractal3(FastNoise* fn, int x, int y, int z);
void fn_gradient_perturb3(FastNoise* fn, FN_DECIMAL* x, FN_DECIMAL* y, FN_DECIMAL* z);
void fn_gradient_perturb_fractal3(FastNoise* fn, FN_DECIMAL* x, FN_DECIMAL* y, FN_DECIMAL* z);
