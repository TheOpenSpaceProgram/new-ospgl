...
bl_info = {
    "name": "FBX format for Open Space Program",
    "author": "Campbell Barton, Bastien Montagne, Jens Restemeier",
    "version": (4, 20, 2),
    "blender": (2, 81, 6),
    "location": "File > Import-Export",
    "description": "FBX OSP IO meshes, UV's, vertex colors, materials, textures, cameras, lamps and actions",
    "warning": "",
...
class ImportFBXOSP(bpy.types.Operator, ImportHelper):
    """Load a FBX file"""
...
@orientation_helper(axis_forward='-Z', axis_up='Y')
class ExportFBXOSP(bpy.types.Operator, ExportHelper):
    """Write a FBX file or Open Space Program"""
